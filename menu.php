...
<div class="logo">
	...
	<div class="nav"><div class="navcontent">
		<div class="button">
			<a href="index.php"><h2>STRONA GŁÓWNA</h2></a>
		</div>
...
<div class="content">
	<div class="tlo_tekstu jeden"><h1>Menu</h1>
		<p>Proszę wybrać kategorię, która Państwa interesuje.</p>
	<div class="menu-type-hold">	
		<div class="menu-type main_course">
			<a href="main_course.php"><span></span><h2>DANIA GŁÓWNE</h2></a>
		</div>
		<div class="menu-type pizza">
			<a href="pizza.php"><span></span><h2>PIZZE</h2></a>
		</div>
		<div class="menu-type pasta">
			<a href="pasta.php"><span></span><h2>MAKARONY</h2></a>
		</div>
	</div>
	<div class="clear"></div>
	</div>
